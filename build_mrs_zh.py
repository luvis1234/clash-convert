...
RULE_GROUPS = {
    "Reject_Ads": [
        ...
        "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/refs/heads/master/rule/Clash/AdvertisingTest/AdvertisingTest_Domain.yaml"# 此处替换为 adblockmihomo.yaml 等其他广告规则链接
    ],
    "Direct_CN": [
